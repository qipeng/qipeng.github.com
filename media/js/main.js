...
function loadgoogletranslate() {$("#googletranslate").html("<img src=\"/media/images/loader.gif\" />&nbsp;Loading Google Translate Gadget...");$.ajax({type: "GET",url: "/media/googletranslate.html",dataType:"html",success: function(data){$("#googletranslate").html(data);}});}
function loadsociallinks() {$("#sociallinks").html("<img src=\"/media/images/loader.gif\" />&nbsp;Loading SNS Buttons...");$.ajax({type: "GET",url: "/media/sociallinks.html",dataType:"html",success: function(data){$("#sociallinks").html(data);}});}
