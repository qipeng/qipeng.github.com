...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-how-to-tell-if-your-ai-truly-generalizes",
      
        title: "How to Tell If Your AI Truly Generalizes",
      
      description: "Humanity developed the best AI model on Earth and brought it to Mars. How do we make sure that it still works when there&#39;s no one around to fix it when it breaks?",
      section: "Posts",
      handler: () => {
        
          window.location.href = "/blog/ai-generalization/";
